...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = 0.250; // X is the up and down direction
    ...
    public static double X_MULTIPLIER = 1.002071418206148; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.006986053501229; // Multiplier in the Y direction
